...
const demoScripts: Script[] = [
  // TikTok scripts (3)
  {
    ...
    segments: [
      ...
      { label: "CALL TO ACTION", content: "Both available this week only. Stop by Capitol Car Credit or call 217-555-1234. We have financing options for every credit situation." },
    ],
  ...
  },
  {
    ...
    segments: [
      ...
      { label: "CALL TO ACTION", content: "Thanksgiving special ends Sunday. Come see Shad at Capitol Car Credit. We're here to help, not hassle!" },
    ],
    caption: "This CR-V won't last long! 🚗💨\n#HondaCRV #SUVDeals #ThanksgivingSale #CCC #Rantoul #UsedCars #fyp",
    status: "pending",
  },
  {
    id: "3",
    ...
    segments: [
      ...
      { label: "CALL TO ACTION", content: "Got questions about winter prep? Stop by Capitol Car Credit. We'll check your tires for free - buying or not!" },
    ],
    caption: "Don't slip up this winter! ❄️🚗\n#WinterTires #CarTips #TireSafety #PennyTest #CCC #CarMaintenance #fyp",
    status: "pending",
  },
  // Facebook script (1)
  {
    ...
    segments: [
      ...
      { label: "CALL TO ACTION", content: "Bad credit? No credit? Fresh start? Capitol Car Credit works with 20+ lenders. Apply online or stop by today!" },
    ],
    caption: "Your credit score doesn't define you. 💪\n\nWe've helped thousands of customers get approved when others said no. Apply online or stop by today!\n\n👉 capitolcarcredit.com",
    status: "pending",
  },
  // YouTube script (1)
  {
    ...
    segments: [
      ...
      { label: "CALL TO ACTION", content: "Stop stressing about your score. Call us at 217-555-1234 or apply online. No judgment, just help!" },
    ],
    caption: "Bad Credit Car Buying Tips | Capitol Car Credit\n\nIn this video, Gary breaks down everything you need to know about getting approved for a car loan with less-than-perfect credit.\n\n🔗 Apply Now: capitolcarcredit.com\n📞 Call: 217-555-1234",
    status: "pending",
  },
];
...
function EditableSegment({
  ...
  const isCTA = segment.label === "CTA" || segment.label === "CALL TO ACTION";
    ...
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      ...
      {isActive && currentScript && (
        <div className="p-3 md:p-4 space-y-3 md:space-y-4 bg-white">
          ...
          {/* Post Caption - Always expanded */}
          <div className="mt-4 pt-4 border-t border-gray-200">
            <div className="flex items-center gap-2 text-sm text-gray-600 mb-2">
              <MessageSquare className="w-4 h-4" />
              <span className="font-medium">Post Caption</span>
            </div>
            <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 hover:border-gray-300 transition-colors cursor-text relative group">
              <p className="text-sm text-gray-700 whitespace-pre-wrap pr-8">
                {currentScript.caption}
              </p>
              <button className="absolute right-3 top-3 text-xs text-gray-400 group-hover:text-gray-600 flex items-center gap-1">
        ...
        {allApproved ? (
          <div className="text-center py-8">
            ...
            <label className="flex items-center justify-center gap-2 text-sm text-gray-600 cursor-pointer mb-4">
              ...
              />
              Text/email me when video generation is complete
            </label>
