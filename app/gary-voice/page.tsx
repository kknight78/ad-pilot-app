...
// The script Gary needs to read (~45-60 seconds for quality voice clone)
...
Stop by today and ask for Gary — mention you saw us online and we'll take care of you. That's Capitol Car Credit in Rantoul. See you soon!`;
    ...
    try {
      const previewResponse = await fetch(N8N_VOICE_PREVIEW_URL, {
        ...
        body: JSON.stringify({
          voice_id: voiceId,
          text: text,
          // Voice settings for clearer, more consistent output
          voice_settings: {
            stability: 0.7,           // Higher = more consistent between previews
            similarity_boost: 0.8,    // How close to match the original voice
            style: 0.2,               // Lower = less variation between takes
